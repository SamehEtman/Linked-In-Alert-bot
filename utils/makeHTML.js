module.exports = (num, jobs, referer) => {
  ...
  let HTML = jobs.map((element, idx) => {
    return `<div class="container" style = "font-family: 'Roboto', 'RobotoDraft', Helvetica, Arial, sans-serif; margin: 5px; padding: 5px;"> <div style="padding: 2px 4px"> <a style="color: #0a66c2; font-weight: 700; text-decoration: none; display: inline-block; font-size: 16px;" href="https://www.linkedin.com/jobs/view/${
